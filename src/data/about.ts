...
export const aboutBio = [
  ...
  'The title on my contract says Architect, and the architecture work is genuinely the part I would not want to give up. But the shape of the job has been drifting for years — further from diagrams and further into sitting with the people who have the problem, prototyping something rough enough to argue with, and then owning it through deployment and whatever it does in production afterwards. That is more or less the definition of <strong>forward deployed engineering</strong>, and it is the work I want more of rather than a change of direction.',
];
...
export const aboutDepth: AboutCapabilityArea[] = [
  ...
  },
  {
    ...
    evidence:
      'Two-stage ingest with entity, relationship, topic and community extraction — 90K entities and 150K+ relationships, with hierarchical community detection.',
  },
  {
    area: 'Vector search',
    evidence:
